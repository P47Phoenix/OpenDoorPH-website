...
| Plan | 64% | seo1: 3 self-correction rounds (Lesson-4 reprise); 58aa: 2 self-correction rounds; 56bx: light Plan clean; w0a1: 1 self-correction (AC-4 wiring drift); w1a1: light Plan clean r1; w2a1: 1 self-correction (SM battery drift); w3a1: clean r1 (zero self-correction across all 4 stages) |
...
4. **Release notes must include remediation timelines for ALL known issues.** PO DoD rejects without dates. Validated 9x (most recent: w3a1 — no NEW known issues; deferred #78/#79 unchanged; PO DoD r1 clean).
5. **Tests run locally before push; verify runtime exists before writing tests.** Validated 7x (most recent: w3a1 — Bezalel ran all 5 commands incl. restored type-check; Thomas-UAT independently re-ran type-check on the branch).
6. **After a build-artifact dir rename OR workflow file edit, UAT tech-writer must cross-reference `git show <sha> --stat` (or `git diff master -- <each-existing-workflow>`) before signing DoD.** Sub-rule: when adding a NEW workflow, verify EVERY existing workflow's diff is empty. Validated 8x cumulative (e2e3, 58aa, 56bx, seo1, w0a1, w1a1, w2a1, w3a1 — Ezra-UAT independently verified empty each wave).
8. **BUG_FIX / FEATURE-Light / FEATURE idea-briefs MUST lock an explicit "anti-narrowing assertion" line that downstream primaries copy verbatim — and Plan QA DoD must verify a negative-narrowing test/sentinel exists.** *(Promoted from Plan Lesson 7 to hot-lesson status after 4 consecutive validated applications: w0a1 introduced; w1a1 carried Idea→Plan→Dev runtime sentinel; w2a1 NFR-08 SVG count parity for nth-check; w3a1 AC-6 grep sentinel for `: any|<any>|as any`.)* Validated 4x cumulative. Stage detail: `stages/plan.md` Lesson 7.
...
- Archive: `archive/run-2026-04-04-fx8s.md`, `archive/run-2026-04-04-tw3p.md`, `archive/run-2026-04-05-hc1q.md`, `archive/run-2026-04-08-fb3n.md`, `archive/run-2026-04-10-bf7w.md`, `archive/run-2026-04-10-ga4x.md`, `archive/run-2026-04-12-ev3k.md`, `archive/run-2026-04-14-dv2k.md`, `archive/run-2026-04-22-e2e3.md`, `archive/run-2026-05-03-58aa.md`, `archive/run-2026-05-05-56bx.md`, `archive/run-2026-05-09-seo1.md`, `archive/run-2026-05-13-w0a1.md`, `archive/run-2026-05-13-w1a1.md`, `archive/run-2026-05-13-w2a1.md`, `archive/run-2026-05-13-w3a1.md`
