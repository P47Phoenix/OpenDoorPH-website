 ...
 * this strip sticks at `top-16` — the header's mobile min-height (4rem) — so
...
const TimeStrip: React.FC = () => (
  <div
    ...
    className="md:hidden sticky top-16 z-30 bg-sage text-white flex font-sans text-sm font-semibold"
  >
