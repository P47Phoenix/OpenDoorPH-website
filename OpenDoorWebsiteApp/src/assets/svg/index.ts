...
export { default as TouchIndicator } from './touch-indicator.svg';
export { default as MobileCTAButton } from './mobile-cta-button.svg';
export { default as QuickMap } from './quick-map.svg';
export { default as LoadingSpinner } from './loading-spinner.svg';
export { default as HistoryScrollIcon } from './HistoryScrollIcon';
